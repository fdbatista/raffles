app.controller('MyTicketsController', function($scope, $http) {
    ...
    $scope.toggle = function(modalstate, id) {
        ...
        switch (modalstate) {
            case 'view-tickets':
                $http.get($scope.api_url + 'my-tickets-numbers/?raffle_id=' + id + '&api_token=' + $scope.api_token).success(function(response)
                {
